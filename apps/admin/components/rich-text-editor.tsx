...
import { Code, Bold, Italic, Underline as UnderlineIcon, Strikethrough, List, ListOrdered, Link as LinkIcon, ImagePlus, Heading1, Heading2, Heading3, TerminalSquare } from 'lucide-react'
    ...
    <div className="w-full flex flex-col">
      <div className="flex items-center flex-wrap gap-1 p-2 border border-b-0 rounded-t-md dark:border-gray-700 bg-gray-50 dark:bg-gray-800">
        ...
        <CldUploadWidget 
          ...
          options={{
            folder: "withola/projects/embedded",
            resourceType: "image",
          }}
        >
          {({ open }) => (
