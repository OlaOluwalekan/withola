        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y dark:divide-gray-800">
            {messages.map((msg) => (
              <tr
                key={msg.id}
                className={`transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50 ${msg.isRead ? "opacity-70" : "bg-blue-50/30 dark:bg-blue-900/10"}`}
              >
                <td className="p-4">
                  <div
                    className={`font-medium ${!msg.isRead && "text-blue-600 dark:text-blue-400"}`}
                  >
                    {msg.senderName}
                  </div>
                ...
                <td className="p-4">
                  ...
                  {msg.attachments.length > 0 && (
                    <span className="ml-2 text-[10px] uppercase font-bold tracking-wider bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">
                      Attachments
                    </span>
                  )}
                </td>
