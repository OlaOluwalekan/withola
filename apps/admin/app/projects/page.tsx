          ...
          <tbody className='divide-y dark:divide-gray-800'>
            {projects.map((project) => (
              ...
              >
                ...
                <td className='p-4'>
                  {project.isFeatured ? (
                    <span className='px-2 py-1 bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 text-xs rounded-md font-medium'>
                      Featured
                    </span>
                  ) : (
                    <span className='px-2 py-1 bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400 text-xs rounded-md'>
                      Standard
                    </span>
                  )}
                </td>
