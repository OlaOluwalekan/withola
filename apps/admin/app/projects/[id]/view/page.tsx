      ...
      <div className='bg-white dark:bg-gray-900 rounded-xl shadow-sm border dark:border-gray-800 overflow-hidden'>
        <div className='p-8 border-b dark:border-gray-800'>
          <div className='flex items-center gap-4 mb-4'>
            <span className='text-5xl flex items-center justify-center w-14 h-14'>
              <DynamicIcon icon={project.icon} className='w-12 h-12' />
            </span>
            <div>
          ...
          <div>
            ...
            <div className='flex flex-wrap gap-2'>
              {project.technologies.map((tech) => (
                <span
                  key={tech}
                  className='px-3 py-1 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-md text-sm'
                >
                  {tech}
                </span>
              ))}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              {project.screenShots.map((url, idx) => (
                <a
                  ...
                  target='_blank'
                  rel='noreferrer'
                  className='relative block h-48 rounded-xl overflow-hidden shadow-sm border dark:border-gray-700 hover:opacity-90 transition-opacity'
                >
                  <Image
                    src={url}
