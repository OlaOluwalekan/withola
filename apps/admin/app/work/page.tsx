          ...
          <tbody className="divide-y dark:divide-gray-800">
            {experiences.map((work) => (
              ...
              >
                <td className="p-4">
                  <Link
                    href={`/work/${work.id}/view`}
                    className="font-medium text-lg hover:text-blue-600 dark:hover:text-blue-400 transition-colors block"
                  >
                    {work.jobTitle}
                  </Link>
                  <div className="text-gray-600 dark:text-gray-400">
                    {work.company} • {work.companyLocation}
                  </div>
                </td>
